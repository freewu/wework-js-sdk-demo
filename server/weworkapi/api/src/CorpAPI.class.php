...
class CorpAPI extends API
{
    ...
    // 获取群获取客户群列表 https://developer.work.weixin.qq.com/document/path/92120
    public function GroupChatList()
    { 
        self::_HttpCall('/cgi-bin/externalcontact/groupchat/list?access_token=ACCESS_TOKEN', 'POST', array('limit'=>10));
        return $this->rspJson;
    }
     ...
     */
    public function TagAddUser($tagid, $userIdList=array(), $partyIdList=array(), &$invalidUserIdList = array(), &$invalidPartyIdList= array())
    {
    ...
    public function BatchInvite(
        ...
        &$invalidUserIdList = array(), &$invalidPartyIdList= array(), &$invalidTagIdList= array())
    {
     ...
     * @return : string ticket
     */
    public function AgentConfigTicketGet()
    {
        self::_HttpCall(self::GET_AgentConfig_TICKET, 'GET', array()); 
        return $this->rspJson;
    }
